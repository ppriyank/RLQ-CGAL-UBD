...
class LaST(object):
    ...
    def __init__(self, root='data', **kwargs):
        ...
        logger.info("    val      |     0 |    921  |    6700  |   11232   |   2526 ") 
        logger.info("    train    |     5 |    550  |    7965  |   32091   |  30637 ") 
        logger.info("    test     |    38 |   2698  |   19481  |   60188   |  53124 ") 
        logger.info("  -------------------------------------------------------------")
...
class LaST_custom_colors(LaST):
    def __init__(self, root='data', new_clothes_pids = True, **kwargs):
        ...
        colors_full = [('green', 1), ('blue',1), ('purple',1), ('red',1), ('yellow',1), ('pink',1)]
...
class LaST_CC_gender(LaST_custom_colors):
